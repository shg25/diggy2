...
style: |
  ...
  h1 { color: #f66; font-size: 1.5em; margin-top: 0; }
  ...
  section table tr:nth-child(even) td { background: #141d38; }
  section table strong { color: #fc6; }
  footer { color: #667; }
  section.lead { text-align: center; justify-content: center; }
  section.lead h1 { font-size: 1.9em; }
  img { background: transparent; }
  /* 見出しを上寄せで固定(会長指摘: コンテンツの高さがまばらで
     扱いづらい)。既定は縦中央寄せなので、通常スライドは上詰めに */
